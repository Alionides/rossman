...
class BlogItemController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new BlogItem());

        $grid->column('id', __('Id'));
        $grid->column('blog_category_id', __('Blog category id'));
    ...
    {
        $show = new Show(BlogItem::findOrFail($id));
