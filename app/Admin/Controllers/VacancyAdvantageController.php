...
class VacancyAdvantageController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'VacancyAdvantage';
    ...
    {
        $grid = new Grid(new VacancyAdvantage());
    ...
    {
        $show = new Show(VacancyAdvantage::findOrFail($id));
    ...
    {
        $form = new Form(new VacancyAdvantage());
